ggBrain
========
[![Build Status](https://travis-ci.org/ttriche/ggBrain.png?branch=master)](https://travis-ci.org/ttriche/ggBrain)
...
## main package
library(devtools)
install_github('ttriche/ggBrain',build_vignettes=TRUE)
